            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color:dodgerblue;" href="index.php?c=department">Department</a></li>
                            ...
                            <form enctype="multipart/form-data" method="post" action="index.php?c=department&m=handle-update&id=<?= $infoDetail['id']; ?>">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            <label> Date </label>
                                            <input type="date" class="form-control" name="beginning_date" value="<?= $infoDetail['date_beginning']; ?>" />
                                        </div>
                                        <div class="form-group mb-3">
                                            <label> Logo </label>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <button style="background-color: dodgerblue;" class="btn btn-success btn-lg" type="submit" name="btnUpdate"> Update </button>
                                    </div>
                                </div>
                            </form>
                        </div>
