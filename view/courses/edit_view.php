            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a style="color: pink;" href="index.php?c=course">Course</a></li>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="post" action="index.php?c=course&m=handle-update&id=<?= $infoDetail['id']; ?>">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="department_id" id="" class="form-control">
                                                <?php foreach ($detailName as $key => $item) : ?>
                                                    <option value="<?php echo $item['id']; ?>" <?= $infoDetail['department_id'] == $item['id'] ? 'selected' : null; ?>>
                                                        <?php echo $item['name']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <button style="background-color: pink;" class="btn btn-success btn-lg" type="submit" name="btnUpdate"> Update </button>
                                    </div>
                                </div>
                            </form>
                        </div>
